      ...
      <header className={`fixed top-0 w-full transition-all duration-500 flex justify-between items-center px-10 py-4 ${isScrolled ? 'bg-gray-800' : ''}`}>
        ...
        <nav>
          <ul className="flex gap-5">
            <li>
              <a href="#services" className="text-white hover:underline" onClick={() => handleNavClick('services')}>Services</a>
            </li>
            <li>
              <a href="#about-us" className="text-white hover:underline" onClick={() => handleNavClick('about')}>About</a>
            </li>
            <li>
